 ...
 * [start] emits partial transcripts via [onPartial]; [stop] returns the final result.
 * Errors and end-of-speech also resolve the in-flight call.
 *
    ...
    fun start(
        ...
        recognizer.setRecognitionListener(object : RecognitionListener {
            ...
            override fun onError(error: Int) {
                ...
                resolve(SpeechResult.Error(msg))
            }
